...
from backend.src.wide_resnet import WideResNet
...
def age_gen_analyse(path):
    label = ''
    args = get_args()
    depth = args.depth
    k = args.width
    weight_file = '/home/vinu-dev/Documents/Personal/Research work/CIS/models/weights.18-4.06.hdf5'
    img = cv2.imread(path)
    if not weight_file:
...
if __name__ == '__main__':
    age_gen_analyse('/home/vinu-dev/Documents/Personal/Research work/CIS/src/Criminal_Identification_System/static/suspect1536174320178.jpg')
